...
public class activity_main_borrar extends AppCompatActivity {
    ...
    public void btnBorrarGestor_Click(View view){
        String dato = "";
        dato = txtDato.getText().toString().trim();
        ServicioGestor.eliminarRegistros(dato);
        Toast.makeText(this, "La tienda se ha eliminado", Toast.LENGTH_LONG).show();
    }
}